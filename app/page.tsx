            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-10 flex flex-col gap-8">
              ...
              <div>
                ...
                <ul className="flex flex-col gap-3 mb-6">
                  ...
                  <li className="flex items-start gap-3">
                    <span className="flex-shrink-0 mt-0.5">{CheckIcon()}</span>
                    <span><strong>Weekly 1-Hour Strategy Sessions</strong> to align on goals and progress</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="flex-shrink-0 mt-0.5">{CheckIcon()}</span>
                    <span><strong>Up to 25 hours of Hands-On Support</strong> for comprehensive campaign execution</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="flex-shrink-0 mt-0.5">{CheckIcon()}</span>
                    <span><strong>Campaign Strategy & Planning</strong> including audience segmentation and journey mapping</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="flex-shrink-0 mt-0.5">{CheckIcon()}</span>
                    <span><strong>Performance Analysis & Optimization</strong> with detailed reporting and insights</span>
                  </li>
                </ul>
                <div className="font-semibold mb-2">Perfect For:</div>
                <ul className="flex flex-col gap-3 mb-6">
                  ...
                  <li className="flex items-start gap-3">
                    <span className="flex-shrink-0 mt-0.5">{CheckIcon()}</span>
                    <span>Comprehensive Braze strategy development</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="flex-shrink-0 mt-0.5">{CheckIcon()}</span>
